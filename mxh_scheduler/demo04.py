...
class GetDataFromCtp():
    def __init__(self,InstrumentID):
       ...
       self.trader.Connect(b'tcp://180.168.146.187:10001')
       self.market.Connect(b'tcp://180.168.146.187:10011')
       #交易账号登陆
    ...
    def queryMarketDate(self):
        ...
        if flag:
            ...
            result = self.trader.QryDepthMarketData(self.InstrumentID)
            print(result)
            print('没有到时间段，不能添加数据')
